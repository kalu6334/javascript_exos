const entrepreneurs = [
  ...
  function isSeventy(element) {
    if (element.year < 1980 &&  element.year >= 1970)
    return element.year
  }
 ...
 const ordre = entrepreneurs.sort(function (a, b) {
    var lastA = a.last.toUpperCase(); // ignore upper and lowercase
    var lastB = b.last.toUpperCase(); // ignore upper and lowercase
    if (lastA < lastB) {
      return -1;
    }
    if (lastA > lastB) {
